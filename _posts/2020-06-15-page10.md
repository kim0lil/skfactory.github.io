...
Argument Resolver는 이전 다루었던 HttpMessageConvert의 하위 종속체이며 Http Message Convert를 사용하였다면 고민할 필요 없이 넘어가도 되겠습니다.

![ ](https://github.com/kim0lil/skfactory.github.io/blob/master/screenshots/2020/06/15/img000001.png?raw=true)

ReturnValueResolver는 다음 포스팅에서 다루도록 하겠습니다.
...
이번에는 파라미터의 타입을 기준으로 서포트 여부를 확인하도록 작성해보도록 하겠습니다.
