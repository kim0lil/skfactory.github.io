...
![ ](https://github.com/kim0lil/skfactory.github.io/tree/master/screenshots/ant/0000001.png)
...
이제부터가 ANT를 다루는 실제 구간이며 처음 들어 보는 내용도 있을 것이나

한걸음 한걸음씩 설명할 예정이니 어렵지 않게 따라하고 습득 할수 있을 것입니다.

먼저 ant 파일을 만들어 보겠습니다.

(원하는 곳에 폴더를 만든 다음 작업 하도록 합니다.)

파일의 명칭은 `build.xml`으로 하여 파일을 생성합니다.

build.xml 파일을 열어 수정 할 준비를 합니다.

(vscode, sublime와 ultra edit와 같은 편집기를 사용하시면 더욱 편합니다.)

가장먼저 알아야 할 것은 ant에 최종 태그는 `project`라는 것입니다.

따라서 먼저 project 태그를 등록하겠습니다.
...
![ ](https://github.com/kim0lil/skfactory.github.io/tree/master/screenshots/ant/0000002.png)
...
혹시나 build.xml말고 다른 이름으로 빌드 파일을 만드셨다면 -f 옵션 명령어를 사용하여 빌드 스크립트를 실행 할수 있습니다.
